...
<form id="order_read">
	<h3 class="alert alert-success" role="alert">
		Bon de Commande N° <?php echo $this->_data_model['id'] ?>
	</h3>
	<fieldset class="form-group">
		<legend>Informations personnelles : </legend>
		<label for="lastname">Nom :</label><input id="lastname" name="lastname" class="form-control" type="text" value="<?php echo $this->_data_model['lastname'] ?>" />
		<label for="firstname">Prénom :</label><input id="firstname" name="firstname" class="form-control" type="text" value="<?php echo $this->_data_model['firstname'] ?>" />
		<label for="email">Email :</label><input id="email" name="email" class="form-control" type="email" value="<?php echo $this->_data_model['email'] ?>" />
	</fieldset>
	<!--  Brand choice -->
	<fieldset class="form-group">
		...
		<!-- Model price -->
		<label for="model_price">Valeur (€) :</label><input id="model_price" type="number" name="model_price" class="form-control" value="<?php echo $this->_data_view['model_price'] ?>" />
		</fieldset>
	<!-- Gearbox -->
	<fieldset>
		...
		<!--  Gearbox price -->
		<label for="gearbox_price">Valeur (€) :</label><input id="gearbox_price" class="form-control" type="number" value="<?php echo $this->_data_view['gearbox_price'] ?>" />
	</fieldset>
	<!-- Color -->
	<fieldset>
		...
		<input id="color_price" type="number" value="<?php echo $this->_data_view['color_price'] ?>" />
	</fieldset>
	<!-- Options -->
	<fieldset>
		...
		<!-- Options price -->
		<label for="options_price" >Total des options (€) :</label><input id="options_price" class="form-control" type="number" value="<?php echo $this->_data_view['options_price'] ?>" />
	</fieldset>
	<fieldset>
		<legend>Reprise de l'ancien véhicule (€) :</legend>
		<label for="return_price">
			<input id="return_price" type="number" name="return_price" class="form-control"  value="<?php echo $this->_data_model['return_price'] ?>" min="0" max="3000"/>
		</label>
	</fieldset>
	<fieldset>
		<legend>Prix total (€) :</legend>
		<label for="total_price">
			<input id="total_price" type="number" name="total_price" class="form-control" value="<?php echo $this->_data_model['total_price'] ?>" />
		</label>
	</fieldset>
</form>
