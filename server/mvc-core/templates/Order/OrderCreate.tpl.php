...
<form id= "order_create" method="post" action="">
	...
	<fieldset>
		...
		<!-- Options price -->
		<label for="options_price" >Total des options (€) :</label>
		<input id="options_price" class="form-control" type="number" readonly="readonly" value="<?php echo $this->_data_view['options_price'] ?>" />
	</fieldset>
	<fieldset>
