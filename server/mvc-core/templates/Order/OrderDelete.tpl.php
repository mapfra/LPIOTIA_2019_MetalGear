 ...
 */
 -->
<form id= "order_delete" method="post" action="">
	<h3 class="alert alert-danger" role="alert">
		Suppression du Bon de Commande N° <?php echo $this->_data_model['id'] ?>
	</h3>
	...
	<div>
		<input id="remove" type="submit" value="Supprimer" class="btn btn-danger" />
	</div>
</form>
