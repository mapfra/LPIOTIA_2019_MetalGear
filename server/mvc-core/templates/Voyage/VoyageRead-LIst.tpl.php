...
<form id= "voyage_read" method="post" action="">
	...
	<fieldset class="form-group">
		<label for="villearr">Ville d'arrivée :</label><input id="villearr" name="villearr" class="form-control" type="text" required="required" value="<?php echo $this->_data_model[$n]['villearr'] ?>" />
